...
Func Example()
	...
	Local $iW = 600, $iH = 600
	Local Const $iBgColor = 0x555555 ;$iBGColor format RRGGBB
	...
	$g_hPen = _GDIPlus_PenCreate(0xFF8080FF, 3)
	GUISetOnEvent($GUI_EVENT_CLOSE, "_Exit")

	Local Const $fDeg = ACos(-1) / 180, $iRadius = 250, $iWidth = $iW / 2, $iHeight = $iH / 2
	Local $fAngle = 0
