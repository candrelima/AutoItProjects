...
#EndRegion When running compiled script, Install needed DLLs if they don't exist yet
...
;
; Syntax:           _WaitForImageSearch, _WaitForImageSearchArea
; Parameter(s):
...
;===============================================================================
Func _WaitForImageSearchArea($findImage, $waitSecs, $resultPosition, $x1, $y1, $right, $bottom, ByRef $x, ByRef $y, $tolerance, $transparency = 0)
	$waitSecs = $waitSecs * 1000
	$startTime = TimerInit()
	While TimerDiff($startTime) < $waitSecs
		Sleep(100)
		If _ImageSearchArea($findImage, $resultPosition, $x1, $y1, $right, $bottom, $x, $y, $tolerance = 0, $transparency = 0) Then
			Return True
		EndIf
	WEnd
	Return False
