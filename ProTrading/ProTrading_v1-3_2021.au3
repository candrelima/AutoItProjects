...
#AutoIt3Wrapper_Outfile_x64=ProTrading_v1-3_2021.exe
...
$Form1 = GUICreate("ProTrading_v1.3-2021", 299, 445, 55, 189, $WS_OVERLAPPEDWINDOW, $WS_EX_APPWINDOW)
...
$Label_Specs = GUICtrlCreateLabel("B <> S", 16, 28, 120, 17)
...
$Button_Compra = GUICtrlCreateButton("Compra", 124, 24, 81, 20)
GUICtrlSetBkColor(-1, 0xB9D1EA)
GUICtrlSetTip(-1, "Copiar dados da lista")
$Button_Venda = GUICtrlCreateButton("Venda", 205, 24, 81, 20)
GUICtrlSetBkColor(-1, 0xB9D1EA)
